...
const AuthenticBadge = styled(Box)(({ theme }) => ({
  display: 'inline-flex',
  alignItems: 'center',
...
const Product = () => {
  ...
  // All your existing useEffect, functions, and logic remain exactly the same...
  useEffect(() => {
    console.log("useEffect 1");
    // ensure metamask is available; we don't need to store the account here
    findMetaMaskAccount();
  ...
  // setData is now defined above as a stable callback (see `setData`)
      ...
      <Container maxWidth="md" sx={{ position: "relative", zIndex: 1 }}>
        <GlassBox>
          ...
          <Box sx={{ textAlign: "center", mb: 3 }}>
            <AuthenticBadge>
              <VerifiedIcon sx={{ color: '#0F1B4C', mr: 1 }} />
              <Typography variant="body2" sx={{ color: '#0F1B4C', fontWeight: 600 }}>
          ...
          <ProductCard>
            ...
            {/* Product Timeline */}
            <Typography variant="h6" sx={{ color: '#0F1B4C', fontWeight: 600, mb: 2, mt: 3 }}>
              Product History
            </Typography>
          ...
          <Box sx={{ mt: 4, textAlign: "center" }}>
            <Typography variant="body2" sx={{ color: "rgba(0, 0, 0, 0.6)" }}>
              Product Verification • Anti-FakeProduct System
            </Typography>
          </Box>
        </GlassBox>
      </Container>
...
// Keep your existing findMetaMaskAccount function outside the component
